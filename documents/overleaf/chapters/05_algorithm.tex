...
The algorithm takes an instance of \texttt{Infrastructure} and \texttt{Application} as inputs, and outputs an optimal deployment strategy (\texttt{AppDeployment}).
